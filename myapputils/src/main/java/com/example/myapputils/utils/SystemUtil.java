package com.example.myapputils.utils;
...
import com.example.myapputils.app.MyApp;
...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) MyApp.getMyApp().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
